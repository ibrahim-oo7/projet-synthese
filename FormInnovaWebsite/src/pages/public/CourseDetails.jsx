          ...
          <div style={styles.modulesSection}>
            ...
            <div style={styles.quizBtnWrapper}>
              <p style={styles.quizInfo}>
                Videos completed: <strong>{completedLessons.length}</strong> /{" "}
                {totalLessons}
              </p>

              <button
                style={
                  isQuizEnabled ? styles.quizButton : styles.quizButtonDisabled
                }
            ...
            {video ? (
              ...
              <div style={styles.videoPlaceholder}>
                ...
                <p style={styles.placeholderSub}>
                  Choose any lesson from the sidebar on the left
                </p>
              </div>
            )}
          </div>

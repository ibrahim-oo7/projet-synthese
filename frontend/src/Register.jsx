            ...
            <div>
              ...
              <div className="flex gap-3">
                <div className="flex items-center gap-3 p-3 border border-[black]/30 rounded-xl hover:border-[#15BE6A] transition-colors cursor-default w-64 h-16">
                  <input type="radio" value="student" onChange={onchangeRole} name="role"  checked readOnly className="w-4 h-4 text-[#15BE6A] focus:ring-[#15BE6A]/20" />
                  <label className="text-base text-gray-700 flex-1 cursor-default">Student</label>
                </div>
                <div className="flex items-center gap-3 p-3 border border-[black]/30 rounded-xl hover:border-[#15BE6A] transition-colors cursor-default w-64 h-16">
                  <input type="radio" value="center" onChange={onchangeRole} name="role" className="w-4 h-4 text-[#15BE6A] focus:ring-[#15BE6A]/20"  />
